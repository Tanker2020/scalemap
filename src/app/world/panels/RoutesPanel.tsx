...
import type { HttpTemplate } from '../../../lib/nodeConfig'
...
export function RoutesPanel() {
  ...
  const submit = () => {
    ...
    addRoute({ name: name.trim(), method, path: path.trim() })
    setName(''); setPath('/')
  }
  ...
  return (
    <div>
      ...
      <Explainer>
        ...
        rules. With no routes, every population sends a single default class.
      </Explainer>
